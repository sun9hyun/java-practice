...
public class BreadPlate {
   ...
   public static BreadPlate breadPlate; // static은 new로 만들지 못함 
   
   public int breadCount;
   public int eatCount;
   
   private BreadPlate() {;} // private 기본 생성자 선언 
...
//   만든 빵이 9개가 넘어가면, 쓰레드를 멈춰준다.
   public synchronized void makeBread() { //동기화 해주기 
      if(breadCount > 9) {
...
//   만약 빵을 먹게 되면, 멈춰있던 쓰레드를 깨워준다.
   public synchronized void eatBread() { //동기화 해주기 
      if(eatCount == 20) {
