...
//      for (int i = 0; i < datas.size(); i++) { //배열의 길이만큼(8번)반복해서 더해주는 반복문
//         System.out.println(datas.get(i)); // 값으로 보여줌
//      }
      
//      System.out.println(datas); //배열로 보여줌
//      
      Collections.sort(datas); //크기 순서대로 정렬
      System.out.println(datas);
//      
      Collections.reverse(datas); //크기 역순대로 정렬
      System.out.println(datas);
//      
      Collections.shuffle(datas); //무작위로 정렬
      System.out.println(datas);
